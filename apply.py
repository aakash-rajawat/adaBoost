...
from adaboostSimple import adaboost_simple
...
alphaK, para = adaboost_simple(X, Y, kMax, nSamples)
...
classLabels, logits = eval_adaBoost_simple_classifier(X_, alphaK, para)
...
alphaK_sc, para_sc = adaboost_simple(X, Y, kMax, nSamples)
...
classLabels_sc, logits_sc = eval_adaBoost_simple_classifier(X_, alphaK_sc, para_sc)
